...
def login():
    ...
    response = token.get_oauth().fetch_request_token(token_request_url)
    ...
    url = token.get_oauth().authorization_url(
...
def login_callback():
    ...
    oauth = temporary_token.get_oauth(verifier=oauth_verifier)
